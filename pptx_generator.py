...
def generar_pptx_completo(datos, output_path):
    ...
    for i, (num, titulo) in enumerate(secciones):
        ...
        add_textbox(s, num, x_num, y, inches(0.42), Pt(13),
                    font_name=SERIF, font_size=18.0, color=PISTACHO)
    ...
    for i, par in enumerate(parrafos):
        add_textbox(s, par, inches(0.65), inches(4.50) + i * inches(1.22),
                    W - inches(1.30), Pt(78),
                    font_name=SANS, font_size=17.7, color=OSCURO, word_wrap=True)
