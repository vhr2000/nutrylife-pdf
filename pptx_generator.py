...
def generar_pptx_completo(datos, output_path):
    ...
    for i, (num, nombre_e, series, reps, musculo, tip) in enumerate(ejercicios):
        ...
        # Barra de acento izquierda (pistacho para impares, lila para pares)
        acento = PISTACHO if i % 2 == 0 else LILA
        add_rect(s, x, y, Pt(5), CARD_H, fill_color=acento)

        # Número
        add_textbox(s, num, x + Pt(14), y + Pt(10), Pt(30), Pt(22),
                    font_name=SERIF, font_size=16, italic=True, bold=True,
                    color=acento, word_wrap=False)

        # Nombre del ejercicio
        add_textbox(s, nombre_e, x + Pt(50), y + Pt(10),
                    CARD_W - Pt(60), Pt(22),
                    font_name=SERIF, font_size=14, bold=True, color=OSCURO,
                    word_wrap=False)

        # Músculo target
        add_textbox(s, musculo, x + Pt(50), y + Pt(32),
                    CARD_W - Pt(60), Pt(14),
        ...
        # Línea separadora
        add_line(s, x + Pt(14), y + Pt(84), CARD_W - Pt(28))

        # Tip de técnica
        add_textbox(s, tip, x + Pt(14), y + Pt(92),
                    CARD_W - Pt(28), Pt(50),
