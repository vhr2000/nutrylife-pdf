...
def generar_pdf_completo(datos: dict, output_path: str):
    ...
    def render_comida(label, comida_data, es_almuerzo_cena=False):
        ...
        if imagen_path:
            try:
                img = CircularImage(imagen_path, size=3.5*cm)
                fila = [[
                    [
                        Paragraph(label,
                                  ParagraphStyle("ct_label2", fontName=FONT_SANS_BOLD, fontSize=10,
                                                 textColor=PISTACHO_DARK, letterSpacing=1.2, spaceAfter=2)),
                        Paragraph(nombre,
                                  ParagraphStyle("ct_nombre2", fontName=FONT_SERIF_ITAL, fontSize=17,
                                                 textColor=TEXTO, leading=21, spaceAfter=4)),
                        Paragraph(descripcion,
                                  ParagraphStyle("ct_desc2", fontName=FONT_SANS, fontSize=12,
                                                 textColor=TEXTO_SOFT, leading=16)),
                    ],
                    img
                ]]
        ...
        story.append(Paragraph(label,
            ParagraphStyle("ct_label", fontName=FONT_SANS_BOLD, fontSize=10,
                           textColor=PISTACHO_DARK, letterSpacing=1.2, spaceAfter=2)))
        story.append(Paragraph(nombre,
            ParagraphStyle("ct_nombre", fontName=FONT_SERIF_ITAL, fontSize=17,
                           textColor=TEXTO, leading=21, spaceAfter=4)))
        story.append(Paragraph(descripcion,
            ParagraphStyle("ct_desc", fontName=FONT_SANS, fontSize=12,
